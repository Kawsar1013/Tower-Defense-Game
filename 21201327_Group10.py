...
CELL_SIZE = GRID_LENGTH // GRID_SIZE  # Size of each grid cell
...
def draw_tower():
    ...
    if selected_tower_type == "nafin":
        ...
        glVertex3f(-10, -30, 20)
        glEnd()
        glColor3f(0.0, 0.0, 0.0)  # Black front panel
        glBegin(GL_QUADS)
        glVertex3f(-5, 20, 10)
        glVertex3f(5, 20, 10)
        glVertex3f(5, 20, 20)
        ...
        for i in range(12):
            ...
            glTranslatef(45, 0, 5)
            glColor3f(0.0, 0.8, 0.8)  # Cyan spheres
        ...
        for i in range(8):
            ...
            glEnd()
            glPopMatrix()
        glColor3f(0.6, 0.2, 0.8)  # Purple cone
        glTranslatef(0, 0, 10)
        quadric = gluNewQuadric()
        gluCylinder(quadric, 40, 0, 30, 8, 1)
        # Draw arrow
        glTranslatef(0, 0, 30)
        glRotatef(arrow_angle, 0, 0, 1)
        glColor3f(1.0, 1.0, 1.0)  # White arrow
        glBegin(GL_TRIANGLES)
        glVertex3f(0, 0, 0)
        glVertex3f(20, 5, 0)
        glVertex3f(20, -5, 0)
        ...
        glColor3f(0.2, 0.8, 0.2)  # Green base
        gluCylinder(gluNewQuadric(), 30, 30, 100, 8, 1)
        # Add vertical fins
        glColor3f(0.8, 0.8, 0.0)  # Yellow fins
        for i in range(6):
            glPushMatrix()
            ...
            glPopMatrix()
        glTranslatef(0, 0, 100)
        glColor3f(0.8, 0.8, 0.0)  # Yellow accents
        for i in range(8):
            glPushMatrix()
            glRotatef(i * 45, 0, 0, 1)
            glBegin(GL_QUADS)
            ...
            glEnd()
            glPopMatrix()
        glColor3f(0.2, 0.8, 0.2)  # Green midsection
        gluCylinder(gluNewQuadric(), 30, 30, 30, 8, 1)
        glTranslatef(0, 0, 30)
        glColor3f(0.8, 0.8, 0.0)  # Yellow platform
        glBegin(GL_QUADS)
        glVertex3f(-10, -30, 0)
        glVertex3f(10, -30, 0)
        glVertex3f(10, -30, 20)
...
def showScreen():
    ...
    if wave_notification:
        ...
        glColor3f(1.0, 0.8, 0.0)  # Bright yellow/gold
